...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	public function new(dialogueList:DialogueFile, ?song:String = null)
	{
		...
		//FlxG.sound.playMusic(Paths.music('breakfast'), 0.8, true);
		...
		arrow = new FlxSprite(1170, 640).loadGraphic(Paths.image('arrow'));
		arrow.updateHitbox();
		arrow.visible = true;
	    arrow.scale.set(4.3, 4.3);
		add(arrow);
		FlxTween.tween(arrow, {x: arrow.x - 50}, 1, {ease: FlxEase.quadInOut, type: PINGPONG});
