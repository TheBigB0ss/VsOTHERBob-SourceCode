...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Funny :clown:', "CLOWN"],
		['Space Shit', ""],
		['shadows', "Value 1: Color \n0 = Green, \n1 = Red, \n2 = Orange \n3 = Yellow \n4 = Purple, \n5 = Brown, \n6 = Black, \n7 = Cyan, \n8 = Blue"],
		['Back to the normal', ""],
		['Cam Hud Angle', "Value 1: CamHud angle\n\nValue 2: \n Duration"],
		['Fake Countdown', 'Value 1:\n1 = ready\n2 = set\n3 = go'],
		['rubys', "Value 1: rubys, \nValue 2: time"],
		['bad amongus', ""],
		['five coins', ""],
		['add coin', ""],
		['test shit', ""],
		// TEST
		['windows pop up', "Value 1: text, \nValue 2: window name"],
		['new window', "Value 1: Title, \nValue 2: image Name"],
	...
	**/
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('bgsStuff/blackBG'));
		bg.scrollFactor.set();
		bg.color = 0xFF000000;
		add(bg);
