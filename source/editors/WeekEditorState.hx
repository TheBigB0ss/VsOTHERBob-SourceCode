...
class WeekEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		var tracksSprite:FlxSprite = new FlxSprite(FlxG.width * 0.07, bgSprite.y + 435).loadGraphic(Paths.image('fnf Shit lol/Menu_Tracks'));
...
class WeekEditorFreeplayState extends MusicBeatState
{
	...
	override function create() {
		bg = new FlxSprite().loadGraphic(Paths.image('fnf Shit lol/menuDesat'));
