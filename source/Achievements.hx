...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["fuck you little bitch",		"Beat Bob Week 1",				'Week_bob_1',			false],
		["little shit",				"Beat Bob Week 2",				'Week_bob_2',			false],
		["fucked",			"Beat Bob Week 3",				'Week_bob_3',			false],
		["CHEATER",			"play glitcher song",				'cheater',			false],
		["YOU ARE AN IDIOT HAHAHAHAHA",			"play malware song",				'idiot',			false],
		["I'm cool",			"play the awesome song",				'awesome',			false],
		["politic war",			"play the elections song",				'elections',			false],
		["I am Gilbert Garfield",			"play the anomaly song",				'anomaly',			false],
...
class AttachedAchievement extends FlxSprite {
	...
	public function reloadAchievementImage() {
		if(Achievements.isAchievementUnlocked(tag)) {
			loadGraphic(Paths.image('AwardsStuff/achievementgrid'), true, 150, 150);
			animation.add('icon', [Achievements.getAchievementIndex(tag)], 0, false, false);
			animation.play('icon');
		} else {
			loadGraphic(Paths.image('AwardsStuff/lockedachievement'));
		}
		scale.set(0.7, 0.7);
		updateHitbox();
	}
...
class AchievementObject extends FlxSpriteGroup {
	...
	public function new(name:String, ?camera:FlxCamera = null)
	{
		...
		var achievementIcon:FlxSprite = new FlxSprite(achievementBG.x + 10, achievementBG.y + 10).loadGraphic(Paths.image('AwardsStuff/achievementgrid'), true, 150, 150);
